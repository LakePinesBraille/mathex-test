...
const ee_settings = (() => {
  ...
  _ee.settings = {
    ...
    "ee-save-font-size" : "0",
    "ee-view-font-size" : 18,
    "ee-print-font-size" : 18,
    "ee-brf-font-size" : 18,
    "ee-brl-font-size" : 18,
  ...
  _ee.palettes = {
    ...
    "ee-plt-logic" : "Logic",
    "ee-plt-lines" : "Lines",
    "ee-plt-arrow1" : "Arrows (single)",
    "ee-plt-arrow2" : "Arrows (double)",
    "ee-plt-arrow3" : "Arrows (triple)",
    "ee-plt-arrow4" : "Arrows (quad)",
    "ee-plt-arrowx" : "Arrows (long)",
    "ee-plt-arrowh" : "Arrows (harpoon)",
    "ee-plt-arrowc" : "Arrows (chemical)",
    "ee-plt-trigonometry" : "Trigonometry",
    "ee-plt-hyperbolic" : "Hyperbolic",
    "ee-plt-modifiers" : "Modifiers",
    ...
    "ee-plt-mstyle" : "Math styles",
    "ee-plt-bullets" : "Bullets",
